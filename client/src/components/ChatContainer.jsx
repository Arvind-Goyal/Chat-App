  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        <img src={selectedUser.profilePic || assests.avatar_icon} alt="" className='w-8 rounded-full' />
        <p className='flex-1 text-lg text-white flex items-center gap-2'> 
          ...
          } src = {assests.arrow_icon } alt="" className='md:hidden max-w-7'/>
          ...
          {messages.map((msg,index)=>(
            <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !== authUser._id &&'flex-row-reverse'}`}>
              ...
              <div className='text-center text-xs'>
                 <img src={ msg.senderId === authUser._id ? authUser?.profilePic|| assests.avatar_icon : selectedUser?.profilePic || assests.avatar_icon} alt="" className='w-7 rounded-full' />
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 '>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          <label htmlFor='image'>
            <img src={ assests.gallery_icon} alt='' className='w-5 mr-2 cursor-pointer'/> </label>
        </div>
